# Adapted: 01/08/2022. From https://www.udemy.com/share/101WfW3@57Z39gcf6lMLKL3cftfuhJpSzS1ElEIigH7Ky8zIP-1_4C8tknUKLpU58CWBEB6HSw==/
# Modified: 08/16/2022. By kiyunlee

# Description
# This program is a part of coursework "Blockchain A-Z™: Learn How To Build Your First Blockchain" from Udemy.
# This program is to build your own blockchain network. 
# Micro web framework, Flask and API platform, Postman will be used to download and distribute blockchain ledger. 
# This is the main code. Other codes represent each node, and they need to be run to connect the network.



# Note
# pip install Flask==0.12.2 Open Anaconda Prompt
...
# run the app
app.run(host='0.0.0.0', port = 5000) # port number represents node number, for example, node 5000
